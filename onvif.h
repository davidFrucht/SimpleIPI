...
void moveDirectionAbselute(int var, int axisPanTiltOrZoom)
{
	...
	case MOVE_PAN:
		sprintf(post, "<?xml version=\"1.0\" encoding=\"utf-8\"?><s:Envelope xmlns:s=\"http://www.w3.org/2003/05/soap-envelope\" xmlns:tptz=\"http://www.onvif.org/ver20/ptz/wsdl\" xmlns:tt=\"http://www.onvif.org/ver10/schema\"> <s:Body> <tptz:AbsoluteMove> <tptz:ProfileToken>%s</tptz:ProfileToken> <tptz:Velocity> <tt:PanTilt x=\"%.2f\" /></tptz:Velocity> TIMEOUT </tptz:ContinuousMove></s:Body></s:Envelope>", profileOnVif.c_str(), degreesToMove);
		break;
	}
	onvifInit(post);
